...
export default function DisplayListings({ onListingClick, category }) {
	...
	const filteredListings = category === "all" ? listings : listings.filter(listing => listing.is_physical === (category === "physicals"));
